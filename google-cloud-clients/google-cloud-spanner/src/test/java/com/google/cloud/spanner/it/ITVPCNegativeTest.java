...
public class ITVPCNegativeTest {
  private static final boolean RUN_VPCSC_TESTS =
      System.getenv("GOOGLE_CLOUD_TESTS_IN_VPCSC") != null
          && System.getenv("GOOGLE_CLOUD_TESTS_IN_VPCSC").equalsIgnoreCase("true");
  private static final String OUTSIDE_PERIMETER_PROJECT =
  ...
  public static void setUpClass() {
    assumeTrue(
        "To run tests, GOOGLE_CLOUD_TESTS_IN_VPCSC environment variable needs to be set to True. "
            + "To Skip, unset the environment variable.",
        RUN_VPCSC_TESTS);
    assertTrue(
        ...
        OUTSIDE_PERIMETER_PROJECT != null && OUTSIDE_PERIMETER_PROJECT != "");
  }

  @Before
  public void setUp() {
    InstanceId instanceId = InstanceId.of(OUTSIDE_PERIMETER_PROJECT, "nonexistent-instance");
    ...
    databaseClient =
        spanner.getDatabaseClient(
            DatabaseId.of(
                OUTSIDE_PERIMETER_PROJECT, "nonexistent-instance", "nonexistent-database"));
  }
